export default function InputForm({ label, name, type, placeholder, plcolor = '', onChange = () => {} }: { label: string, name: string, type: string, placeholder: string, plcolor?: string, onChange?: (event: React.ChangeEvent<HTMLInputElement>) => void }) {
  return (
    <div>
