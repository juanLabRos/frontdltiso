    ...
    return (
        <div className="h-full">
            ...
            <div className="flex flex-col justify-around items-center h-4/5">
                <h2 className="flex text-black text-center text-3xl mt-8 md:mt-24 font-bold">Informe Ejecutivo 👔</h2>
                <section className="flex flex-col md:flex-row justify-center w-full md:w-3/4 mt-4 md:mt-10">
                    <article className="border-r-0 md:border-r-4 w-full md:w-1/2 flex flex-col items-center md:border-black">
